...
import { IntegrationDropdown } from '../integrations/IntegrationDropdown';
import { 
  Mic, 
  MicOff, 
  Video, 
...
export const CallInterface: React.FC<CallInterfaceProps> = ({ 
  ...
  const handleIntegrationSelect = (integration: string) => {
    ...
    // Here you would implement the logic to connect to the selected platform
  };
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <Card className="flex items-center justify-between p-3">
            ...
            <div className="flex items-center space-x-3">
              <IntegrationDropdown onSelect={handleIntegrationSelect} />
              {isOverlayMode && (
                <button
